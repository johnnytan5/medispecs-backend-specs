...
CAMERA_INDEX: Final[int] = 1  # Camera device index (0 for default USB/Pi camera)
...
STT_COMMAND_TIMEOUT: Final[int] = 10  # Seconds to record command after button press
...
# Button Configuration (for STT trigger)
...
ACCELEROMETER_I2C_ADDRESS: Final[int] = 0x68  # MPU6050 I2C address
...
# ============================================================================
MEDICATION_ENABLED: Final[bool] = True  # Enable medication reminders
...
MEDICATION_DETECTION_WINDOW: Final[int] = 5  # Minutes after scheduled time to show reminder
